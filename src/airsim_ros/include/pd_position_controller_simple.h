...
public:
    ...
    PIDParams()
        : kp_x(1.53), kp_y(1.45), kp_z(1.1), kp_yaw(2.3), kd_x(0), kd_y(0), kd_z(0.03), kd_yaw(0), reached_thresh_xyz(1), reached_yaw_degrees(5.0)
    {
    }
...
public:
    ...
    DynamicConstraints()
        : max_vel_horz_abs(7.0), max_vel_vert_abs(4.5), max_yaw_rate_degree(0.55)
    {
    }
