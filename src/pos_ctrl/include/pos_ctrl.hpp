...
private:
    ...
    float goalpath[circlesCount][4] = {{20, 9, -1, 0}, {47.6,5.14,-11,0}, {66,4,-2,0.12},{85,10,-2,0.65}, {102,30,-9,13.5},{96, 15,-2, 1.1}, 
    ...
    ros::Subscriber airsim_circle_pose_sub;
    ...
    void circle_poses_gt_cb(const airsim_ros::CirclePoses& circle_poses);
